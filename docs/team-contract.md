...
| Nama                         | Peran                    |
| ---------------------------- | ------------------------ |
| Benedhictus Kevin Doni B.E.  | Quality Assurance Tester |
| Shaira Masyhita Putri Hatala | Frontend Developer       |
| Silvi Amalia                 | Project Manager          |
| Nayyara Aqila Azra           | Backend Developer        |
...
| Minggu | Project Manager              | Frontend Developer           | Backend Developer            | Quality Assurance Tester     |
| ------ | ---------------------------- | ---------------------------- | ---------------------------- | ---------------------------- |
...
* **Daily Standup:**
  Dilakukan melalui WhatsApp Group dan Discord (termasuk video conference untuk meeting sinkron).
...
* Lebih dari **2 kali absen tanpa izin dalam satu sprint** akan dilaporkan dalam mekanisme eskalasi (lihat Bagian 6).
...
| Discord               | Diskusi terstruktur, penyimpanan file, koordinasi teknis, serta video conference untuk meeting tim | Digunakan sesuai kebutuhan       |
...
* Perubahan diajukan melalui WhatsApp, Discord, atau GitHub Project.
